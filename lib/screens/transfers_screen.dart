...
class _TransfersScreenState extends State<TransfersScreen>
  ...
  Future<void> _completeTransfer() async {
    ...
    try {
      final teamProvider = context.mounted
  ...
  Widget _buildAvailablePlayersTab() {
    return Consumer2<TeamProvider, PlayerProvider>(
      builder: (context, teamProvider, playerProvider, _) {
        ...
        final currentSquadIds =
            teamProvider.team?.players.map((p) => p.id).toSet() ?? {};
        ...
        children: [
          ...
          CustomButton(
            ...
            onPressed:
                ...
                ? _completeTransfer
                : null,
            backgroundColor: _canCompleteTransfer
                ? AppColors.primary
                : AppColors.divider,
          ),
        ],
